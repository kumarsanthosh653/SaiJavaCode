...
# Function to perform authentication and retrieve API key from Secret Manager
def validate_api_key():
    # Simulate fetching API key from Secret Manager
...
def create_scan():
    ...
    if response.status_code == 201:
        ...
        if check_vulnerabilities():
            ...
            print("No vulnerabilities found. Continuing the pipeline.")
    else:
